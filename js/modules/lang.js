...
const labels = {
  en: {
    ...
    photoOf: "Photo of",
    availability: "Open to backend internship opportunities",
    ...
    contact: {
      ...
      intro: "The fastest way to reach me is by email. You can also connect on LinkedIn or send a message below.",
      emailMe: "Email me",
    ...
    projectsPage: {
      ...
      galleryLabel: "Project interface previews",
  ...
  vi: {
    ...
    downloadCv: "Tải CV",
    photoOf: "Ảnh của",
    availability: "Đang tìm cơ hội thực tập Backend Engineer",
    proofLabel: "Năng lực kỹ thuật nổi bật",
    proof: {
      systemsValue: "2",
    ...
    skills: {
      ...
      additional: "Kỹ năng bổ trợ"
    },
    contact: {
      formLabel: "Gửi lời nhắn",
      intro: "Cách nhanh nhất để liên hệ với tôi là qua email. Bạn cũng có thể kết nối trên LinkedIn hoặc gửi lời nhắn bên dưới.",
      emailMe: "Gửi email",
      openLinkedIn: "LinkedIn",
      name: "Họ tên",
    ...
    projectsPage: {
      ...
      galleryLabel: "Hình ảnh giao diện dự án",
      interfacePreview: "ảnh giao diện",
      project: "dự án",
      projects: "dự án",
